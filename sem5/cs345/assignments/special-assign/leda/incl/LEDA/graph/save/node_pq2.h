...
#define LEDA_ROOT_INCL_ID 600176
...
template <class P,class graph_t,class prio_impl,class ItemArray>
...
node_pq(const graph_t& G, ItemArray& I, int sz) : prio_impl(sz),gr(G), ITEM(I)
{ /*ITEM.use_node_data(G,nil); */}
 
node_pq(const graph_t& G, ItemArray& I) : prio_impl(G.number_of_nodes()),gr(G), ITEM(I) {}
...
{ ITEM[v] = (node)prio_impl::insert(leda_cast(x),v);}
