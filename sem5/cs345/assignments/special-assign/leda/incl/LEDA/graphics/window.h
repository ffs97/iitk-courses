...
#define LEDA_ROOT_INCL_ID 600142
...
int read_mouse(const point& p, int timeout1, int timeout2, 
                       bool& double_click, bool& drag)
{ return read_mouse(p.xcoord(),p.ycoord(),timeout1,timeout2,double_click,drag);}
/*{\Mop  ... }*/
...
static bool open_url(string url);
...
extern __exportF void LedaFileViewer(const list<string>& file, int w, int h, 
                                                               string label);
extern __exportF void LedaFileViewer(const list<string>& file);
...
#if defined(__win32__) && defined(WINMAIN)
