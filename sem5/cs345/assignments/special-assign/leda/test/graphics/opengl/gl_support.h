...
// 3d simplex output 
// inside must be a point inside the 3d simplex ...

void gl_draw_simplex(const d3_simplex& s, const d3_point& inside)
{
  d3_point p1 = s.point1(); 
  d3_point p2 = s.point2(); 
  d3_point p3 = s.point3(); 
  d3_point p4 = s.point4();   
  
  gl_draw_triangle(p1,p2,p3, inside);
  gl_draw_triangle(p1,p3,p4, inside);
  gl_draw_triangle(p1,p4,p2, inside); 
  gl_draw_triangle(p2,p3,p4, inside);   
}
