...
void geowin_generate_objects(GeoWin& gw, std::vector<My_Point>& L)
{
}

string geowin_info_fcn(const std::vector<My_Point>& L)
{
 string s;
 return s;
}
...
int main()
{
  geowin_init_default_type((std::vector<My_Point>*)0,string("MyPointvector")) ;
