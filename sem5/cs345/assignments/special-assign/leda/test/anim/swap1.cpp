...
{ M[&i] = gw_stick_element(x, 10, point(130 + 35 * id++, 100));
  V.add_element(M[&i]);  
}
...
{ //M[&i] = gw_stick_element(0, 10, point(140 + 35 * id++, 100));
  M[&i] = gw_stick_element(0, 10, point(120 + 35 * id1++, 250));
  V.add_element(M[&i]);  
  cell_assign(i,j);
}
